  ...
  return (
    <html lang="en">
      <body className="bg-stone-50 text-stone-800 flex flex-col min-h-screen">
        ...
        {/* GLOBAL NAVBAR */}
        <header className="<header className="sticky top-0 z-50 bg-stone-50 border-b>
          <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-10 text-sm tracking-wide">
              ...
              <span className="text-stone-700 cursor-default">
                Find a Spa
              </span>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-stone-700 cursor-default">
                Sign In
              </span>
