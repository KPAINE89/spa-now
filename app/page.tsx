      ...
      <main className="relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
          <div className="text-center">
            ...
            <form onSubmit={handleSearch} className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl shadow-stone-200/50 p-8 border border-stone-100">
              <div className="grid md:grid-cols-2 gap-5 mb-6">
                <div className="text-left">
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3.5 border border-stone-200 rounded-2xl focus:ring-2 focus:ring-[#C5DDD3] focus:border-[#7A9E87] transition bg-stone-50/50 text-stone-800 placeholder-stone-400 font-light"
                  />
                </div>
                <div className="text-left">
                  <label className="block text-xs font-light text-stone-500 mb-2 tracking-wider uppercase">
                  ...
                  <select
                    ...
                    className="w-full px-5 py-3.5 border border-stone-200 rounded-2xl focus:ring-2 focus:ring-[#C5DDD3] focus:border-[#7A9E87] transition bg-stone-50/50 text-stone-800 font-light appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[length:12px] bg-[position:right_1.25rem_center] bg-no-repeat"
                  >
              ...
              <button
                type="submit"
                className="w-full bg-[#7A9E87] text-white py-4 rounded-2xl text-base font-light tracking-wide hover:bg-[#6B8F77] transition shadow-lg shadow-[#7A9E87]/20 hover:shadow-xl hover:shadow-[#7A9E87]/30"
              >
        ...
        <div className="py-24 bg-gradient-to-b from-stone-50 to-[#EAF2EE]/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              {/* Left: Benefits */}
              <div>
                <div className="h-px w-16 bg-gradient-to-r from-[#7A9E87] to-transparent mb-6" />
                <h3 className="text-4xl font-light text-stone-800 mb-8 tracking-tight leading-tight">
                  Your wellness,
                  <br />
                  <span className="text-[#7A9E87]">simplified.</span>
                </h3>

                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 rounded-full bg-[#7A9E87] mt-2.5 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-stone-600 text-sm font-light leading-relaxed">
                        See exactly what's open right now, today, or whenever you are ready.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-3xl p-10 text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#7A9E87]/10 rounded-full -mr-32 -mt-32" />
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#7A9E87]/10 rounded-full -ml-24 -mb-24" />

                <div className="relative">
                  <div className="h-px w-12 bg-[#7A9E87]/50 mb-6" />
                  ...
                  <div className="space-y-3 mb-10">
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-[#7A9E87] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="py-24 bg-white">
          <div className="max-w-3xl mx-auto text-center px-4">
            ...
            <button className="bg-[#7A9E87] text-white px-10 py-4 rounded-full text-base font-light tracking-wide hover:bg-[#6B8F77] transition shadow-xl shadow-[#7A9E87]/20 hover:shadow-2xl hover:shadow-[#7A9E87]/30">
              Start Your Search
            </button>
          </div>
        </div>
